			...
			<table width="100%" cellspacing="0" cellpadding="0">
				<tr>
					<td height="10" align="center" style="font-size: 22px;"><a
						href="Order?initial=ga">ㄱ</a> <a href="Order?initial=na">ㄴ</a> <a
						href="Order?initial=da">ㄷ</a> <a href="Order?initial=ra">ㄹ</a> <a
						href="Order?initial=ma">ㅁ</a> <a href="Order?initial=ba">ㅂ</a> <a
						href="Order?initial=sa">ㅅ</a> <a href="Order?initial=aa">ㅇ</a> <a
						href="Order?initial=ja">ㅈ</a> <a href="Order?initial=cha">ㅊ</a> <a
						href="Order?initial=ka">ㅋ</a> <a href="Order?initial=ta">ㅌ</a> <a
						href="Order?initial=pa">ㅍ</a> <a href="Order?initial=ha">ㅎ</a></td>
				</tr>
				<tr>
					<td>
						<table align="center" width="40%" cellspacing="0" cellpadding="0"
							...
							<td><c:forEach var="xx" items="${list }" varStatus="status">
							...
							<td>
								...
								<!--########## 다음 페이지 링크 출력 ############ -->
								 <c:if test="${ curPage < totalPage  }">
										<a href="Diction?curPage=${ curPage + 10 }">[다음 페이지]</a>
								</c:if>
							</td>
						</tr> <!-- end paging -->
					</table>
