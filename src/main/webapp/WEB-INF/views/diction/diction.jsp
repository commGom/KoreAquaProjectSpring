...
<body>
				...
				<table width="100%" cellspacing="0" cellpadding="0">
					<tr>
						<td height="10" align="center" style="font-size: 22px;"><a
							href="OrderServlet?initial=ga">ㄱ</a> <a
							href="OrderServlet?initial=na">ㄴ</a> <a
							href="OrderServlet?initial=da">ㄷ</a> <a
							href="OrderServlet?initial=ra">ㄹ</a> <a
							href="OrderServlet?initial=ma">ㅁ</a> <a
							href="OrderServlet?initial=ba">ㅂ</a> <a
							href="OrderServlet?initial=sa">ㅅ</a> <a
							href="OrderServlet?initial=aa">ㅇ</a> <a
							href="OrderServlet?initial=ja">ㅈ</a> <a
							href="OrderServlet?initial=cha">ㅊ</a> <a
							href="OrderServlet?initial=ka">ㅋ</a> <a
							href="OrderServlet?initial=ta">ㅌ</a> <a
							href="OrderServlet?initial=pa">ㅍ</a> <a
							href="OrderServlet?initial=ha">ㅎ</a></td>
					</tr>
					<tr>
						<td>
							<table align="center" width="35%" cellspacing="0" cellpadding="0"
								...
								<tr>
									<td class="paging"
										...
										<%
											if (PrevBlock > 0) {
										%> <a href="DictionServlet?curPage=<%=curPage - 1%>">[이전
											페이지]</a> <%
 	}
 %> <%
 ...
 %> [<a href="DictionServlet?curPage=<%=i%>"><%=i%></a>] <%
 	}
 }
 %> <%
 	if (totalPage >= NextBlock) {
 %> <a href="DictionServlet?curPage=<%=NextBlock%>">[다음 페이지]</a> <%
 	}
 %>
									</td>
								</tr>
